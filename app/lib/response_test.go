...
func TestErrorNotAllowed(t *testing.T) {
	app := fiber.New()

	app.Use(func(c *fiber.Ctx) error {
		return ErrorNotAllowed(c)
	})
	...
	utils.AssertEqual(t, 405, response.StatusCode, "Example 405 response")
}
...
func TestErrorHTTP(t *testing.T) {
	...
	utils.AssertEqual(t, 429, response.StatusCode, "Example 429 response")
}
...
func TestCreated(t *testing.T) {
	...
	utils.AssertEqual(t, 201, response.StatusCode, "Example 201 response")
}
